...
![](../.gitbook/assets/metric-menu.png)

列表中会列出每个指标项的名称、可筛选维度以及这个指标项的具体含义和功能。点击单个指标项的名称，会弹出该指标数据的实时查询页面。

![](../.gitbook/assets/metric_query.png)

## 数据展示形式与原始查询

指标查询界面支持三种数据展示模式、以及查看原始查询的功能。您可以通过点击标签进行切换。

![](../.gitbook/assets/data-show.png)

**时序图**（以线图方式展示每个维度组合随时间的变化）

![](../.gitbook/assets/metric-time-range.png)

**当前值**（以表格方式展示每个维度组合的当前值）

![](../.gitbook/assets/metric-time-curr.png)
...
![](../.gitbook/assets/metric-query-sql.png)
...
![](../.gitbook/assets/metric-host-sel.png)
...
![](../.gitbook/assets/metric-time-sel.png)
